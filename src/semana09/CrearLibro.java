...
public class CrearLibro extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        agregar[0]=txtprincipal.getText();
        agregar[1]=txttitulo.getText();
        agregar[2]=txtautor.getText();
        agregar[3]=txteditorial.getText();
        agregar[4]=txtaño.getText();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        // TODO add your handling code here:
        int elitodo=tabladatos.getRowCount();
    ...
    void impresion(){
        String imagen = "base\\tabladatos.xlsx";//"base\\tabladatos.xlsx";
        String Ruta = System.getProperty("Users.dir")+"\\"+imagen;
        File file = new File(Ruta);
        ExportarExcel excel = new ExportarExcel(tabladatos,file,"tabladatos");
        excel.export();
    }
